...
% Bring argument that it is somewhat critical to have a steady consumer in Background on mobile devices.

%TODO: search if biblatex is able to fullprint authors.
